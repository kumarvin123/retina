...
func (v *ValidateWinBpfMetric) Run() error {
	...
	//v.ExecCommandInWinPod("cd C:\\", v.EbpfXdpDeamonSetName, v.EbpfXdpDeamonSetNamespace)
	...
	v.ExecCommandInWinPod("powershell -Command \"Invoke-WebRequest -Uri 'http://localhost:10093/metrics' -UseBasicParsing | Write-Host $_.Content\"", v.RetinaDaemonSetName, v.RetinaDaemonSetNamespace)
	return nil
}
