...
:CurlAkaMs
   ...
   powershell -Command "Write-Output 'Curl AKA.MS or 23.213.38.151'"
   start "" cmd /c "for /L %%i in (1,1,1000) do (powershell -Command \"Invoke-WebRequest -Uri 'http://23.213.38.151' -UseBasicParsing\" & timeout /t 1 >nul)"
   goto :EOF
